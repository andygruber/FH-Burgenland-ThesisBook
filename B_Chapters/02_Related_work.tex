\chapter{Related work / state of research} 	% Produces section heading.  Lower-level
...
LaTeX \citet{lamport94},  % \cite inserts a reference, which you define at the end of the document
